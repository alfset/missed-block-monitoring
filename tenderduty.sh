...
sed -i.back -e "s\webhook:*\webhook: \"$WEBHOOK\"\g" /workspace/missed-block-monitoring/tenderduty/config.yml
sed -i.back -e "s/valoper_address:*/valoper_address: \"$VALOPERADDRESS\"/" /workspace/missed-block-monitoring/tenderduty/config.yml
##run
